const translations = {
    pl: {
        ...
        'samos-guide-title': 'Przewodnik po Samos',
        'getting-around': 'Poruszanie się po Wyspie',
        'car-rental': 'Wynajem Samochodu',
        'attractions': 'Co Warto Zobaczyć',
        'beaches': 'Najlepsze Plaże',
        'dining': 'Gdzie Jeść i Pić',
        'wedding-day-title': 'Plan Dnia Ślubu',
        'brides-house': 'Dom Panny Młodej',
        'ceremony': 'Ceremonia Ślubna',
        'reception': 'Przyjęcie Weselne',
        'transport-notice': 'Uprzejmie prosimy gości o samodzielną organizację transportu',
        'afterparty-title': 'Afterparty',
        'afterparty-date': '24 Sierpnia 2025',
        'afterparty-time': 'Od 16:00',
        'afterparty-invitation': 'Zapraszamy wszystkich gości na przyjęcie przy basenie w domu Panny Młodej następnego dnia po ślubie',
        'afterparty-note': 'Przekąski i napoje będą zapewnione. Nie zapomnijcie strojów kąpielowych!',
        'wedding-month': 'SIERPIEŃ',
        'wedding-location': 'SAMOS, GRECJA',
        ...
        'samos-guide-title': 'Οδηγός της Σάμου',
        'getting-around': 'Μετακίνηση στο Νησί',
        'car-rental': 'Ενοικίαση Αυτοκινήτου',
        'attractions': 'Αξιοθέατα',
        'beaches': 'Καλύτερες Παραλίες',
        'dining': 'Πού να Φάτε και να Πιείτε',
        'wedding-day-title': 'Πρόγραμμα Ημέρας Γάμου',
        'brides-house': 'Σπίτι της Νύφης',
        'ceremony': 'Γαμήλια Τελετή',
        'reception': 'Γαμήλια Δεξίωση',
        'transport-notice': 'Παρακαλούνται οι καλεσμένοι να οργανώσουν οι ίδιοι τη μεταφορά τους',
        'afterparty-title': 'Afterparty',
        'afterparty-date': '24 Αυγούστου 2025',
        'afterparty-time': 'Από τις 16:00',
        'afterparty-invitation': 'Προσκαλούμε όλους τους καλεσμένους σε ένα pool party στο σπίτι της νύφης την επόμενη μέρα του γάμου',
        'afterparty-note': 'Σνακς και ποτά θα παρέχονται. Μην ξεχάσετε τα μαγιό σας!',
        'wedding-month': 'ΑΥΓΟΥΣΤΟΣ',
        'wedding-location': 'ΣΑΜΟΣ, ΕΛΛΑΔΑ',
        'contact-title': 'Επικοινωνία',
        'contact-intro': 'Για οποιεσδήποτε ερωτήσεις, παρακαλούμε επικοινωνήστε μαζί μας',
